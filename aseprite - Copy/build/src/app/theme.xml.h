...
namespace gen {
  ...
  public:
    ...
    public:
      ...
      const skin::SkinPartPtr& toolTimeline() const { return m_toolTimeline; }
      ...
      const skin::SkinPartPtr& dynamicsOn() const { return m_dynamicsOn; }
    ...
    private:
      ...
      skin::SkinPartPtr m_toolTimeline;
    ...
    public:
      ...
      ui::Style* shadeEmpty() const { return m_shadeEmpty; }
  ...
  protected:
    void updateInternals() {
      ...
      byId(parts.m_toolTimeline, "tool_timeline");
      ...
      byId(parts.m_dynamicsOn, "dynamics_on");
      ...
      byId(styles.m_shadeEmpty, "shade_empty");
